...
class ServerlessGitVariables {
  ...
  _getValueFromGit(variable) {
    ...
    return (0, _asyncToGenerator3.default)(function* () {
      const fakeGitVariables = _this2.serverless.processedInput && _this2.serverless.processedInput.options && _this2.serverless.processedInput.options.fakeGitVariables;
